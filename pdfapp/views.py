    ...
    with connection.cursor() as cursor:
        ...
        if len(bankrupt) == 0:
         ...
         #######################################LETS ROCK#######################################
            ...
            # elif Addr == 3:
                # print('sfsfsdfdsfd')
                # pdf.drawImage('/home/pdfImages/personHome.png',3.5*cm,(26.6)*cm,3.85*cm,0.7*cm,preserveAspectRatio=False);
                # pdf.roundRect(0.75*cm, (20.4)*cm, 9.45*cm, 6.15*cm, 4, stroke=1, fill=0);
                # if houseType =='Rented Apartment' or houseType =='Apartment':
                    # pdf.drawImage('/home/pdfImages/rentedApt.png',0.78*cm,(20.5)*cm,9.3*cm,5.95*cm,preserveAspectRatio=False);
                # else:
                ...
                # pdf.drawString(10.62*cm,(24)*cm,Address);
                # pdf.drawString(10.62*cm,(23)*cm,city+', '+state.title()+' '+pincode);
