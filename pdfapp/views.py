    ...
    with connection.cursor() as cursor:
      ...
      ##################################################LEFT 2nd HALF ##############################################
        ...
        if BRFdate1 != 'NA' and BRFdate2 != 'NA':
            ...
            pdf.setFont('Vera', 12);
            pdf.drawImage('/home/pdfImages/bankrupt.png',13.65*cm,(10+rightSpacing)*cm,0.6*cm,0.45*cm,preserveAspectRatio=False, mask='auto');
        ...
        if EVFdate1 != 'NA' and EVFdate2 != 'NA':
            ...
            pdf.drawImage('/home/pdfImages/eviction.png',13.65*cm,(7.8+rightSpacing)*cm,0.6*cm,0.45*cm,preserveAspectRatio=False, mask='auto');
        ...
        #####JUDGEMENTS###########
        if judments !='NA':
            pdf.drawImage('/home/pdfImages/judgements.png',13.65*cm,(5.6+rightSpacing)*cm,0.6*cm,0.5*cm,preserveAspectRatio=False, mask='auto');
    ...
    with connection.cursor() as cursor:
        ...
        if Addr == 1:
            ...
            if homeEqu1 != '$0':
                ...
                pdf.setFont('Vera', 8);
                pdf.drawCentredString(9.375*cm,(18.8-noSpouseHt)*cm,homeEqu1);
            
        else:
            pdf.drawImage('/home/pdfImages/personHome.png',4.7*cm,(27.8-noSpouseHt)*cm,4*cm,0.5*cm,preserveAspectRatio=False);
            
            if houseType =='Rented Apartment' or houseType =='Apartment':
                pdf.drawImage('/home/pdfImages/rentedApt.png',3.5*cm,(23.25-noSpouseHt)*cm,6*cm,4.5*cm,preserveAspectRatio=False);
                # pdf.drawImage('',5.7*cm,(22.8)*cm,4*cm,0.5*cm,preserveAspectRatio=False);
            else:
                pdf.drawImage('houseImage.jpg',3.5*cm,(23.25-noSpouseHt)*cm,6*cm,4.5*cm,preserveAspectRatio=False);
            
            pdf.roundRect(3.5*cm, (23.25-noSpouseHt)*cm, 6*cm, 4.5*cm, 4, stroke=1, fill=0);
           
            pdf.setFont('VeraBd', 9);
            
            
            if houseType =='Rented Apartment' or houseType =='Rented': 
                pdf.drawImage('/home/pdfImages/rented.png',1.5*cm,(22.5-noSpouseHt)*cm,2.75*cm,0.6*cm,preserveAspectRatio=False);
            if houseType =='For Sale':  
                pdf.drawImage('/home/pdfImages/sale.png',1.5*cm,(22.5-noSpouseHt)*cm,2.75*cm,0.6*cm,preserveAspectRatio=False);
                
            if Address != 'NA':
                pdf.setFont('Vera', 8);
                
                ## pdf.drawString(5.62*cm,(22.25)*cm,Address1+', '+city1+', '+state1+' '+pin1);
                pdf.drawString(1.5*cm,(22-noSpouseHt)*cm,"1.");
                pdf.setFont('Vera', 8);
                
                pdf.drawString(2*cm,(22-noSpouseHt)*cm,Address+', '+city+', '+state.title()+' '+pincode);
                # pdf.drawString(5.6*cm,(22.40)*cm,);
                ...
                if homeEqu1 != '$0':
                    ...
                    pdf.drawString(2*cm,(21.6-noSpouseHt)*cm,"ESTIMATED HOME EQUITY: ");
                    pdf.setFont('VeraBd', 8);
                    pdf.drawString(6*cm,(21.6-noSpouseHt)*cm,homeEqu1);
                    pdf.setFont('Vera', 8);
                if homeEqu1 == '$0':
                    Equiheight = 0.35;
                else:
                ...
                if homeValu1 != '$0':
                    ...
                    pdf.drawString(2*cm,(21.2-noSpouseHt+homeHeight+Equiheight)*cm,"ESTIMATED HOME VALUE: ");
                    pdf.setFont('VeraBd', 8);
                    pdf.drawString(6*cm,(21.2-noSpouseHt+homeHeight+Equiheight)*cm,homeValu1);
                    pdf.setFont('Vera', 8);
                
                # pdf.drawCentredString(7.7*cm,(20.55)*cm,Home_Val);
                pdf.setFillColorRGB(0,0,1)
                pdf.drawString(2.6*cm,(21-noSpouseHt)*cm,'_______________________________')
                pdf.setFillColorRGB(0,0,0)
            ...
            if Address2 != 'NA':
                ...
                ## pdf.drawString(5.62*cm,(22.25)*cm,Address1+', '+city1+', '+state1+' '+pin1);
                pdf.drawString(1.5*cm,(20.6-noSpouseHt)*cm,"2.");
                pdf.setFont('Vera', 8);
                
                pdf.drawString(2*cm,(20.6-noSpouseHt)*cm,Address2+', '+city2+', '+state2.title()+' '+pincode2);
                # pdf.drawString(5.6*cm,(20.90)*cm,);
                ...
                if homeEqu2 != '$0':
                    ...
                    pdf.drawString(2*cm,(20.2-noSpouseHt)*cm,"ESTIMATED HOME EQUITY: ");
                    pdf.setFont('VeraBd', 8);
                    pdf.drawString(6*cm,(20.2-noSpouseHt)*cm,homeEqu2);
                    pdf.setFont('Vera', 8);
                if homeEqu2 == '$0':
                    Equiheight = 0.35;
                else:
                ...
                if homeValu2 != '$0':
                    ...
                    pdf.drawString(2*cm,(19.8-noSpouseHt+homeHeight+Equiheight)*cm,"ESTIMATED HOME VALUE:  ");
                    pdf.setFont('VeraBd', 8);
                    pdf.drawString(6*cm,(19.8-noSpouseHt+homeHeight+Equiheight)*cm,homeValu2);
                    pdf.setFont('Vera', 8);
                pdf.setFillColorRGB(0,0,1)
                pdf.drawString(2.6*cm,(19.6-noSpouseHt)*cm,'_______________________________')
                pdf.setFillColorRGB(0,0,0)
            if Address3 != 'NA':
                pdf.setFont('Vera', 8);
                
                ##pdf.drawString(5.62*cm,(22.25)*cm,Address1+', '+city1+', '+state1+' '+pin1);
                pdf.drawString(1.5*cm,(19.2-noSpouseHt)*cm,"3.");
                pdf.setFont('Vera', 8);
                pdf.drawString(2*cm,(19.2-noSpouseHt)*cm,Address3+', '+city3+', '+state3.title()+' '+pincode3);
                # pdf.drawString(5.6*cm,(19.40)*cm,);
                ...
                # if homeEqu3 != 0:
                    ...
                    pdf.drawString(2*cm,(18.8-noSpouseHt)*cm,"ESTIMATED HOME EQUITY: ");
                    pdf.setFont('VeraBd', 8);
                    pdf.drawString(6*cm,(18.8-noSpouseHt)*cm,homeEqu3);
                ...
                if homeValu3 != '$0':
                    ...
                    pdf.drawString(2*cm,(18.4-noSpouseHt+homeHeight+Equiheight)*cm,"ESTIMATED HOME VALUE:  ");
                    pdf.setFont('VeraBd', 8);
                    pdf.drawString(6*cm,(18.4-noSpouseHt+homeHeight+Equiheight)*cm,homeValu3);
                    pdf.setFont('Vera', 8);
        ...
        if len(edu) == 1 and len(univ) == 1:
            ...
            if edu2 != 'NA':
                if univ2 == 'NA':
                    ...
                    uniHeight = 0;
                pdf.drawCentredString((12.5/2)*cm,(6.54+temp2Extraht+homeHeight+uniHeight)*cm,edu2);
        ...
        if len(bankrupt) == 0:
         ...
         #######################################LETS ROCK#######################################
          ...
          ##################################################LEFT 2nd HALF ##############################################
            ...
            pdf.setFillColorRGB(255,255,255)
            pdf.setFont('Vera', 12);
            pdf.drawString(13.75*cm,(10.5+rightSpacing)*cm,'________________________________')
            
            pdf.drawString(14*cm,(9.7+rightSpacing)*cm,'POSSIBLE JUDGMENTS');
            
            if judments !='NA':
                pdf.drawImage('/home/pdfImages/checked.png',19.6*cm,(9.5+rightSpacing)*cm,0.8*cm,0.8*cm,preserveAspectRatio=False, mask='auto');
            else:
                pdf.drawImage('/home/pdfImages/blank.png',19.6*cm,(9.5+rightSpacing)*cm,0.8*cm,0.8*cm,preserveAspectRatio=False, mask='auto');
                
            pdf.drawString(14*cm,(9+rightSpacing)*cm,'POSSIBLE EVICTIONS');
            if EVFdate1 != 'NA' and EVFdate2 != 'NA':
                pdf.drawImage('/home/pdfImages/checked.png',19.6*cm,(8.8+rightSpacing)*cm,0.8*cm,0.8*cm,preserveAspectRatio=False, mask='auto');
            else:
                pdf.drawImage('/home/pdfImages/blank.png',19.6*cm,(8.8+rightSpacing)*cm,0.8*cm,0.8*cm,preserveAspectRatio=False, mask='auto');
            pdf.drawString(14*cm,(8.3+rightSpacing)*cm,'POSSIBLE BANKRUPTCIES');
            
            if BRFdate1 != 'NA' and BRFdate2 != 'NA':
                pdf.drawImage('/home/pdfImages/checked.png',19.6*cm,(8.1+rightSpacing)*cm,0.8*cm,0.8*cm,preserveAspectRatio=False, mask='auto');
            else:
                pdf.drawImage('/home/pdfImages/blank.png',19.6*cm,(8.1+rightSpacing)*cm,0.8*cm,0.8*cm,preserveAspectRatio=False, mask='auto');
            pdf.drawString(13.75*cm,(8.1+rightSpacing)*cm,'________________________________')       
            if len(licences) == 0:
                licenLen=2
            else:
                licenLen=0
